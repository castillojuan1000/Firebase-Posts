  ...
  return (
    <article className="Post">
      ...
      <div className="Post--meta">
        ...
        <div>
          <button className="star" onClick={addStart}>Star</button>
          {deleteOnlyUser(currentUser, user) && <button className="delete" onClick={deleteDoc}>Delete</button>}
        </div>
      </div>
    </article >
  );
